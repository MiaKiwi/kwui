...
export default class CSSVariables extends AbstractComponent {
    static _rawStylingRules = [
        `:root{--letter-spacing:0.5em;--muted-transparency:0.75;--disabled-transparency:0.5;--border-roundness:0.5em;--box-shadow:rgba(0, 0, 0, 0.025) 0 6px 24px 0px, rgba(0, 0, 0, 0.028) 0 0 0 1px;--inline-block-spacing:0.25em;--border-thin-width:0.125em}`,
